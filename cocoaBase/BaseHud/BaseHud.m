...
{
    [BaseHud popMessage:message withCustomIcon:[UIImage imageNamed:@"success.png"]];
}

+(void) popError:(NSString*)message
{
    [BaseHud popMessage:message withCustomIcon:[UIImage imageNamed:@"error.png"]];
}
...
+(void) popWaiting
{
    [BaseHud popWaiting:@"加载中..."];
}

+(void) popWaiting:(NSString*)hint
{
    [BaseHud popWaiting:hint userInteractionEnabled:YES];
}
